...
const twitterUrl = (slug) => `https://mobile.twitter.com/search?q=${pageUrl(slug)}`
const hnUrl = (slug, title) =>
  `https://news.ycombinator.com/submitlink?u=${pageUrl(slug)}&t=${encodeURIComponent(title)}`
